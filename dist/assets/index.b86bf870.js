import{g as l,S as x,A as w}from"./vendor.ca80a63e.js";const y=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))d(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const p of a.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&d(p)}).observe(document,{childList:!0,subtree:!0});function i(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerpolicy&&(a.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?a.credentials="include":r.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function d(r){if(r.ep)return;r.ep=!0;const a=i(r);fetch(r.href,a)}};y();const n={html:`<div id="content" class="bg-white  flex flex-col" style="font-family: Barlow;">\r
	<header id="whoobe-z4fyu" class=" flex flex-col">\r
		<div id="moka-89inu" class=" items-center justify-center p-8 md:grid flex flex-col md:grid-cols-3">\r
			<div id="moka-y1j89" class="bg-gray-800 items-center text-purple-600  text-6xl justify-center md:justify-center h-full w-48 rounded-full shadow-lg py-2 flex flex-row col-span-1" style="font-family: &quot;Barlow Condensed&quot;;">\r
				<span type="element" class="text-white    text-2xl" id="whoobe-bn2xj">whoobe</span>\r
				<span type="element" class="text-purple-400    text-2xl" id="whoobe-ng3ow">\r
					<b>One</b>\r
				</span>\r
				<i type="element" class="text-yellow-500  text-2xl ml-1 material-icons" id="whoobe-opl6m">bubble_chart</i>\r
			</div>\r
			<nav id="moka-7352w" class="items-center text-lg text-black px-2 h-full justify-around mt-4 md:mt-0 flex flex-row col-span-2" style="font-family: Barlow;">\r
				<a href="https://whoobe-one-studio.vercel.app">\r
					<span type="element" title="span" class="border-b-4 border-transparent hover:text-purple-600 hover:border-purple-600  cursor-pointer text-base md:text-lg mx-6" id="moka-qf08u">Try now!</span>\r
				</a>\r
				<a href="https://github.com/swina/whoobe-one-studio">\r
					<span type="element" title="span" class="border-b-4 border-transparent hover:text-purple-600 hover:border-purple-600  cursor-pointer text-base md:text-lg mx-6" id="moka-dmapa">Github</span>\r
				</a>\r
			</nav>\r
		</div>\r
	</header>\r
	<div id="whoobe-m96oz" class="md:py-20 p-2 md:px-8 lg:px-20 flex">\r
		<div id="whoobe-dh5ys" class="items-end justify-start w-full  bg-white bg-opacity-75 m-auto flex flex-col md:grid grid-cols-2">\r
			<div id="whoobe-mnoa2" class="items-start justify-center w-full p-5 h-auto flex flex-col col-span-1" style="transform: translate(0px, 0px); opacity: 1; visibility: inherit;">\r
				<h4 type="element" class="text-black text-5xl my-6" id="whoobe-2ex7f" style="font-family: Barlow;">A <b>components designer</b>\r
				<br>for TailwindCSS</h4>\r
				<h4 type="element" class="text-gray-400" id="whoobe-dmzke" style="font-family: Barlow;">Open source UI to design and create components to use in your projects.</h4>\r
				<a href="https://github.com/swina/whoobe-one-studio">\r
					<button type="button" value="button" title="button" class="hover:text-gray-300 bg-purple-600 text-white hover:bg-bluegray-600 p-4 text-2xl font-bold rounded-full shadow-lg mt-8" id="whoobe-k1mmi" style="font-family: Barlow;">Try whoobeOne. It's free!</button>\r
				</a>\r
			</div>\r
			<div id="whoobe-q35eq" class="items-center justify-center w-full h-64 md:h-full bg-cover bg-center bg-no-repeat rounded-lg shadow-lg  flex flex-col" style="background-image: url(&quot;https://res.cloudinary.com/moodgiver/image/upload/v1635019951/whoobe-splashscreen_y7ziga.jpg&quot;); transform: translate(0px, 0px); opacity: 1; visibility: inherit;">\r
			</div>\r
		</div>\r
	</div>\r
	<div id="whoobe-r2oyh" class="px-2 md:px-10 mb-20 mt-20 flex flex-col">\r
		<div id="whoobe-uhft0" class="w-full flex flex-col md:flex-row">\r
			<div id="whoobe-cg24q" class="w-full md:w-2/3 flex">\r
				<img type="element" src="https://res.cloudinary.com/moodgiver/image/upload/v1635019951/whoobe-one-editor-02_nbtccf.jpg" alt="img" title="img" class="w-full m-auto h-auto border shadow-lg my-8 rounded-2xl" id="whoobe-4o9mx">\r
				</div>\r
				<div id="whoobe-2d4ka" class="w-full md:w-1/3 flex">\r
					<div id="whoobe-w39lx" class="items-center justify-center h-auto md:p-2 lg:p-10 flex flex-col">\r
						<span id="whoobe-9h74v" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
						...
						<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-dkyks" style="font-family: Barlow;">Editor</h4>\r
						<p type="element" class="mt-8 text-center text-lg" id="whoobe-p21t9">\r
		...
		<div id="whoobe-thcd7" class="px-2 md:px-10  flex flex-col">\r
			<div id="whoobe-7yp2p" class="w-full flex flex-col md:flex-row">\r
				<div id="whoobe-zwbrs" class="w-full md:w-1/3 flex">\r
					<div id="whoobe-0ncxy" class="items-center justify-center h-auto md:p-2 lg:p-10 flex flex-col">\r
						<span id="whoobe-tjzdo" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
						...
						<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-7y9pf" style="font-family: Barlow;">HTML Code</h4>\r
						<p type="element" class="mt-8 text-center text-lg" id="whoobe-e8hxn">\r
				...
				<div id="whoobe-veldb" class="w-full md:w-2/3  flex">\r
					<pre type="element" class="w-full overflow-x-auto max-w-screen" id="whoobe-nye63">&lt;div class="bg-white  flex flex-col" id="content" &gt;
	...
	<div id="whoobe-ou1k4" class="px-2 md:px-10 mt-20 flex flex-col">\r
		<div id="whoobe-lrnow" class="w-full flex flex-col md:flex-row">\r
			<div id="whoobe-t30kv" class="w-full md:w-2/3 flex">\r
				<img type="element" src="https://res.cloudinary.com/moodgiver/image/upload/v1634149257/whoobe-one-library_d73ok6.jpg" alt="img" title="img" class="w-full m-auto h-auto border shadow-lg my-8 rounded-2xl" id="whoobe-1rxcm">\r
				</div>\r
				<div id="whoobe-1c06e" class="w-full md:w-1/3 flex">\r
					<div id="whoobe-32seu" class="items-center justify-center h-auto md:p-2 lg:p-10 flex flex-col">\r
						<span id="whoobe-3jn9l" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
						...
						<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-z7xhk" style="font-family: Barlow;">Library</h4>\r
						<p type="element" class="mt-8 text-center text-lg" id="whoobe-69u7v">\r
		...
		<h2 type="element" class="text-center mt-20" id="whoobe-qdtu5">\r
			<b>Features</b>\r
		</h2>\r
		<div id="whoobe-fy8wu" class=" flex">\r
			<main id="whoobe-7cfbi" class="md:gap-20 md:grid flex flex-col md:grid-cols-3">\r
				<div id="whoobe-j5nu9" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-w0ox7" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-vqfq8" style="font-family: Barlow;">Browser UI</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-iwq9f">\r
						<p>In browser based app, that you can add to your desktop. </p>\r
						<p>No database or server required.</p>\r
					</p>\r
				</div>\r
				<div id="whoobe-ecm3v" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-h7in8" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-sfgws" style="font-family: Barlow;">TailwindCSS</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-8vvsw">\r
						<p>Manage almost all TailwindCSS utility-first classes with advanced and easy controls</p>\r
					</p>\r
				</div>\r
				<div id="whoobe-anarw" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-8iqrz" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-1rm1g" style="font-family: Barlow;">AlpineJS</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-bcmrd">Assign AlpineJS directives and customize as per your needs</p>\r
				</div>\r
				<div id="whoobe-f7l8e" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-jydks" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-7algt" style="font-family: Barlow;">Custom JS</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-oh8fx">Add your custom Javascript to any component.</p>\r
				</div>\r
				<div id="whoobe-n1p3w" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-8pjf4" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-d2l5v" style="font-family: Barlow;">GSAP</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-h4js8">GreenSock animation support. 15 most used animations presets. Cusomize duration, ease and delay.</p>\r
				</div>\r
				<div id="whoobe-fjjpj" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-igu0q" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-7ero0" style="font-family: Barlow;">Snippets</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-fttqd">\r
						<p>Add preset templates like info card, hero section, team and more with one click</p>\r
					</p>\r
				</div>\r
				<div id="whoobe-42na4" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-l53zw" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-8fcfw" style="font-family: Barlow;">Multitabs</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-vvywa">\r
						<p>Open multiple editors to speed your workflow on different components simultaneously</p>\r
					</p>\r
				</div>\r
				<div id="whoobe-7ezmm" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-j7a1u" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-lhv3q" style="font-family: Barlow;">Duplicate</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-hj3mk">Duplicate blocks easely with a simple Alt + D</p>\r
				</div>\r
				<div id="whoobe-km5pj" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-ue39b" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16" class="iconify iconify--vaadin">\r
							<path fill="currentColor" d="M13 4h-3V0H0v14h6v2h10V7l-3-3zM3 1h4v1H3V1zm12 14H7V5h5v3h3v7zm-2-8V5l2 2h-2z">\r
							</path>\r
						</svg>\r
					</span>\r
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-4cto9" style="font-family: Barlow;">Copy&amp;Paste</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-yq55l">Copy&amp;Paste blocks also between different components in different tabs.</p>\r
				</div>\r
				<div id="whoobe-qh82o" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-ub3kd" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					...
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-fwkzd" style="font-family: Barlow;">CopyFormat</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-baq64">Copy CSS and style and paste to any element to replicate the same design</p>\r
				</div>\r
				<div id="whoobe-d5z7t" class="items-center justify-start h-auto md:p-2 lg:p-10 my-4 flex flex-col">\r
					<span id="whoobe-uqywe" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" class="iconify iconify--ic">\r
							<path d="M9 3L5 6.99h3V14h2V6.99h3L9 3zm7 14.01V10h-2v7.01h-3L15 21l4-3.99h-3z" fill="currentColor">\r
							</path>\r
						</svg>\r
					</span>\r
					<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-x7e13" style="font-family: Barlow;">Export/Import</h4>\r
					<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-b3cl1">Export/Import any template to/from JSON<div>on your local file system</div>\r
				</p>\r
			</div>\r
			<div id="whoobe-kn8zi" class="items-center justify-start h-auto md:p-2 lg:p-10 flex flex-col">\r
				<span id="whoobe-9wjk9" class="z-highest text-bluegray-500    text-8xl" mode="render" block="">\r
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16" class="iconify iconify--bi">\r
						<g fill="currentColor">\r
				...
				<h4 type="element" class="text-white bg-purple-800 mt-8 px-3 rounded-full font-bold text-2xl py-1" id="whoobe-c5mo0" style="font-family: Barlow;">Shortcuts</h4>\r
				<p type="element" class="mt-8 text-center text-base p-2" id="whoobe-lxmhx">Speed-up your workflow with support of hotkeys for most used operations</p>\r
			</div>\r
		</main>\r
	</div>\r
	<footer id="whoobe-c9792" class="text-gray-300  bg-gray-900 p-4 md:p-10 md:grid flex flex-col md:grid-cols-1">\r
		<div id="moka-1bhbn" class="text-center justify-center text-xl flex flex-col">\r
			<div type="element" class="" id="whoobe-xz9d4">whoobe<b>One</b>\r
			<div>is a free and open source project&nbsp;<div>by Antonio Nardone</div>\r
		</div>\r
	</div>\r
	<div type="element" class="text-gray-400 text-sm mt-4" id="whoobe-huybu">created with</div>\r
	<div id="whoobe-ojehj" class="justify-center text-gray-300 flex">\r
		<span id="whoobe-t69c2" class="z-highest  text-gray-500 text-2xl" mode="render" block="">\r
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" class="iconify iconify--akar-icons">\r
				<g fill="none">\r
		...
		<span id="whoobe-kukdq" class="z-highest  text-gray-500 text-2xl mx-8" mode="render" block="">\r
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" class="iconify iconify--file-icons">\r
				<path d="M128 204.667C145.062 136.227 187.738 102 256 102c102.4 0 115.2 77 166.4 89.833c34.138 8.56 64-4.273 89.6-38.5C494.938 221.773 452.262 256 384 256c-102.4 0-115.2-77-166.4-89.833c-34.138-8.56-64 4.273-89.6 38.5zm-128 154C17.062 290.227 59.738 256 128 256c102.4 0 115.2 77 166.4 89.833c34.138 8.56 64-4.273 89.6-38.5C366.938 375.773 324.262 410 256 410c-102.4 0-115.2-77-166.4-89.833c-34.138-8.56-64 4.273-89.6 38.5z" fill="currentColor">\r
				</path>\r
			</svg>\r
		</span>\r
		<span id="whoobe-9sq27" class="z-highest  text-gray-500 text-2xl" mode="render" block="">\r
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" class="iconify iconify--simple-icons">\r
				<path d="M24 12l-5.72 5.746l-5.724-5.741l5.724-5.75L24 12zM5.72 6.254L0 12l5.72 5.746h11.44L5.72 6.254z" fill="currentColor">\r
				</path>\r
			</svg>\r
...
</div>`,fonts:["Barlow+Condensed","Barlow"],title:"whoobeOne Landing Page",description:"whoobeOne is a no-code visual page builder created with VueJS and TailwindCSS. Use whoobeOne to create stunning TailwindCSS components to add to your pages. AlpineJS and GSAP support.",animations:[{id:"whoobe-mnoa2",gsap:{animation:"slide-down",ease:"power4",duration:"2",delay:0}},{id:"whoobe-q35eq",gsap:{animation:"slide-left",ease:"back",duration:"2",delay:0}}],tags:"no-code,vuejs,tailwindcss,alpinejs,GSAP"},o=.7;l.registerEffect({name:"scale",effect:(e,t)=>l.fromTo(e,{scale:0,opacity:0},{scale:1,opacity:1,duration:t.duration,ease:t.ease,delay:t.delay}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"scale-out",effect:(e,t)=>l.fromTo(e,{scale:1},{scale:1.1,opacity:1,duration:t.duration,ease:t.ease,delay:t.delay}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"scale-in",effect:(e,t)=>l.fromTo(e,{scale:2,opacity:0},{scale:1,opacity:1,duration:t.duration,ease:t.ease,delay:t.delay}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"fade",effect:(e,t)=>l.fromTo(e,{opacity:0},{opacity:1,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"rotate-scale",effect:(e,t)=>l.fromTo(e,{opacity:0,scale:.5,x:300},{duration:t.duration,opacity:1,scale:1,rotation:360,x:0,ease:t.ease,delay:t.delay}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"rotate",effect:(e,t)=>l.to(e,{rotationX:360,opacity:1,scale:1,duration:t.duration,ease:t.ease}),defaults:{duration:o},extendTimeline:!0});l.registerEffect({name:"flip-x",effect:(e,t)=>l.fromTo(e,{opacity:0},{rotationX:360,opacity:1,scale:1,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"flip-y",effect:(e,t)=>l.fromTo(e,{opacity:0},{rotationY:360,opacity:1,scale:1,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"rotate-hover",effect:(e,t)=>l.fromTo(e,{opacity:.4,scaleX:2,rotationX:90},{rotationX:360,opacity:1,scale:1,duration:1,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"slide-left",effect:(e,t)=>l.fromTo(e,{autoAlpha:0,x:300},{autoAlpha:1,x:0,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"slide-right",effect:(e,t)=>l.fromTo(e,{autoAlpha:0,x:-300},{autoAlpha:1,x:0,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"slide-top",effect:(e,t)=>l.fromTo(e,{autoAlpha:0,y:200},{autoAlpha:1,y:0,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"slide-down",effect:(e,t)=>l.fromTo(e,{autoAlpha:0,y:-200},{autoAlpha:1,y:0,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"grow-width",effect:(e,t)=>l.fromTo(e,{opacity:0,x:"100%"},{opacity:1,x:0,duration:t.duration,delay:t.delay,ease:t.ease,clearProps:"opacity"}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"width-reverse",effect:(e,t)=>l.fromTo(e,{opacity:0,x:"100%",width:0},{opacity:1,x:0,width:"100%",duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"close-left",effect:(e,t)=>l.fromTo(e,{scaleX:1,width:"100%",height:"100%"},{scaleX:0,transformOrigin:"0% 100%",duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"close-right",effect:(e,t)=>l.fromTo(e,{x:0},{x:"100%",duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:0,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"growh-eight",effect:(e,t)=>l.fromTo(e,{autoAlpha:1,scaleY:0},{autoAlpha:1,scaleY:1,duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:1,ease:"power1"},extendTimeline:!0});l.registerEffect({name:"rotate-3DY",effect:(e,t)=>l.fromTo(e,{opacity:1},{opacity:1,rotateY:"28deg",transformPerspective:"80vw",duration:t.duration,delay:t.delay,ease:t.ease}),defaults:{duration:o,delay:1,ease:"power1"},extendTimeline:!0});l.registerPlugin(x);document.body.innerHTML=n.html;const f=document.querySelector(".whoobe-slider");var h=document.head;if(n.fonts.length){var c=document.createElement("link");c.type="text/css",c.rel="stylesheet",c.href="https://fonts.googleapis.com/css?family="+n.fonts.join("|"),h.appendChild(c)}try{var m=document.createElement("meta");m.name="keywords",m.setAttribute("content",n.tags),h.appendChild(m)}catch(e){console.log(e)}n.animations&&n.animations.forEach(e=>{let t=document.querySelector("#"+e.id);console.log(e);let i=l.effects[e.gsap.animation](t,{trigger:t,duration:parseFloat(e.gsap.duration),delay:parseFloat(e.gsap.delay),ease:e.gsap.ease});x.create({id:e.id,start:"top 99.99%",trigger:t,toggleActions:"play pause restart none",animation:i,onEnter:()=>{e.gsap.delay?i.play():i.play(0)}})});try{document.title=n.title}catch(e){console.log(e)}try{var u=document.createElement("meta");u.name="description",u.setAttribute("content",n.description),h.appendChild(u)}catch(e){console.log(e)}try{var s=0;let e=parseInt(f.getAttribute("slides")),t=document.querySelector(".slider-next"),i=document.querySelector(".slider-prev"),d=new w(f,{swipe:r=>{r.direction==="Left"&&(s<e&&(s=s+1),t.click()),r.direction==="Right"&&(s>0&&(s=s-1),i.click())},doubleTap:r=>{t.click()}})}catch(e){console.log("No slider found")}
